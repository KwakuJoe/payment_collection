    ...
    <div class="flex flex-col w-full p-6 border border-gray-100 gap-y-5 dark:border-zinc-800">
        ...
        <div class="flex items-center w-full mt-8 gap-x-5">
            ...
            <div
                ...
                <div class="flex flex-col flex-1 ">
                    ...
                    <p class="text-xl font-bold">
                        {{ parseFloat(
                            prepareFormFields[`${paymentStore.selectedPaymentServiceFormFieldIsAmount![0]?.field_name}`]).toFixed(2)
                        ?? null }}
                    </p>
                </div>
            </div>
            ...
            <div class="flex items-start bg-primary/10 gap-x-3 border rounded-sm  border-primary/20  lg:w-[34%] p-5 "
                :class="compareAmountToCashAmount">
                ...
                <div class="flex flex-col flex-1 ">
                    <p class="text-primary">Currency</p>
                    <p class="text-2xl font-bold text-primary">{{ formatCurrency(grandTotal,
                        paymentStore.selectedPaymentService?.currency) }}</p>
                </div>
            </div>
        ...
        <form>
                ...
                <div class="flex flex-col gap-y-4">
                    ...
                    <div class="overflow-hidden border border-gray-100 dark:border-zinc-800">
                        ...
                        <div
                            ...
                            <div class="p-3 text-sm font-semibold border-l border-gray-100 dark:border-zinc-800">
                                Quantity</div>
            ...
            <div class="flex w-full gap-x-5">
                <Button size="lg" severity="secondary" label="BACK" class="w-full lg:w-1/2"
                    @click="paymentStore.previousStep()" />

                <Button size="lg" class="w-full lg:w-1/2" label="COMPLETE PAYMENT" :loading="isVerificationLoading"
