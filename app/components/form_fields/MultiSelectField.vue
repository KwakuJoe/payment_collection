    ...
    <div class="flex flex-col w-full ">
        <div class="flex flex-col items-start w-full gap-y-2">
            <p class="text-sm font-semibold">{{ field.field_label }}</p>
                ...
                <MultiSelect  size="small" display="chip" v-model="prepareFormFields[`${field.field_name}`]" :options="field.list_of_options"   option-label="lov_title" option-value="lov_value"  filter fluid  
    ...
    <div class="flex flex-col lg:w-[100%] gap-5 ">
        ...
        <span v-html="showAsteric"></span>
                ...
                <div class="flex flex-row-reverse  lg:w-[100%] gap-3  md:flex-row">
                   <MultiSelect checkmark  size="small" filter fluid  :options="options" option-value="lov_value"
